...
'''
this scripts is a fast way to join a lot of GPX files downloaded from strava
if you use strava_traces_downloader.py , its can be you second step for join 
...
ex: python join_gpx_strava_files.py gpx_from_workouts salida.gpx
